<template>
  <el-card>
    <h1 class="me-author-name">一筐狐萝卜</h1>
    <div class="me-author-description">
      <span><i class="el-icon-location-outline"></i> &nbsp;上海</span>
      <span><i class="me-icon-job"></i> &nbsp;摸鱼达人</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '1918176773'},
        bilibili: {
          title: '哔哩哔哩',
          message: '<a target="_blank" href="https://space.bilibili.com/10667975">https://space.bilibili.com/10667975</a>'
        }
      }
    },
    methods: {
